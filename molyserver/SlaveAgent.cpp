...
void SlaveAgent::OnAccept( DWORD connindex )
{

}

void SlaveAgent::OnDisconnect()
{
...
void SlaveAgent::OnConnect( BOOL bSuccess, DWORD dwNetworkIndex )
{
}
...
void SlaveAgent::OnRecv( BYTE *pMsg, WORD wSize )
{
